...
/**
 * Converts a Lognity [de.connect2x.lognity.api.logger.Logger] to an SLF4J [org.slf4j.Logger].
 *
 * If the given logger is already a bridged instance, the underlying SLF4J logger is returned.
 */
