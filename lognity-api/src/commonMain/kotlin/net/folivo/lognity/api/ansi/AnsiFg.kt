...
value class AnsiFg @PublishedApi internal constructor(@PublishedApi internal val value: Int) {
    ...
    inline infix fun on(bg: AnsiBg): AnsiSequence = AnsiSequence("${AnsiMod.default(bg)}${AnsiMod.default(this)}")
     ...
     */
    @Suppress("NOTHING_TO_INLINE")
    inline infix fun boldOn(bg: AnsiBg): AnsiSequence = AnsiSequence("${AnsiMod.default(bg)}${AnsiMod.bold(this)}")
}