...
import net.folivo.lognity.gradle.isRelease
    ...
    publications.configureEach {
        if (this is MavenPublication) {
            pom {
                ...
                description.set("Lightweight logging facade and implementation for Kotlin Multiplatform.")
                url.set("https://gitlab.com/trixnity/lognity")
